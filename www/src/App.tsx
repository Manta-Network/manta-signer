    ...
    <div className='App bg-primary flex flex-grow flex-col'>
      ...
      <div className='flex flex-col flex-grow justify-center items-center p-4'>
        ...
        <a
          ...
          href={
            os === 'Mac'
              ? 'https://github.com/Manta-Network/manta-signer/releases/download/0.6.1/manta-signer-macos-latest_0.6.1-103_x64.dmg'
              : os === 'Windows'
              ? 'https://github.com/Manta-Network/manta-signer/releases/download/0.6.1/manta-signer-windows-2019_0.6.1_x64.msi'
              : 'https://github.com/Manta-Network/manta-signer/releases/download/0.6.1/manta-signer-ubuntu-18.04_0.6.1_amd64.deb'
          }
          title={
            os === 'Mac'
