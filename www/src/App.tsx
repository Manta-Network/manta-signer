    ...
    <div className='App bg-primary flex flex-grow flex-col'>
      ...
      <div className='flex flex-col flex-grow justify-center items-center p-4'>
        ...
        <a
          ...
          href={
            os === 'Mac'
              ? 'https://github.com/Manta-Network/manta-signer/releases/download/v1.1.2/manta-signer-macos-latest_1.1.2-103_x64.dmg'
              : os === 'Windows'
              ? 'https://github.com/Manta-Network/manta-signer/releases/download/v1.1.2/manta-signer-windows-2019_1.1.2_x64.msi'
              : 'https://github.com/Manta-Network/manta-signer/releases/download/v1.1.2/manta-signer-ubuntu-18.04_1.1.2_amd64.deb'
          }
          title={
            os === 'Mac'
