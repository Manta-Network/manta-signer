...
int generate_private_transfer_data(unsigned char *root_seed, unsigned char *buffer, const size_t len, void **res, size_t *res_len);
int generate_reclaim_data(unsigned char *root_seed, unsigned char *buffer, const size_t len, void **res, size_t *res_len);
int debug_derive_shielded_address(unsigned char *root_seed, unsigned char *buffer, const size_t len, void **res, size_t *res_len);
